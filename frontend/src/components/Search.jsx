...
const Search = (props) => {
    ...
    return (<div className={classes.form}>
        <Grid container={true}>
            ...
            <Grid container={true} item={true} xs={12} sm={4} justify="center">
                <Paper component="form" className={classes.paper}>
                    <InputBase className={classes.input} placeholder="Type a job" name="what" value={props.searchTitle}
            ...
            <Grid container={true} item={true} xs={12} sm={4} justify="center">
                <Paper component="form" className={classes.paper}>
                    <InputBase className={classes.input} placeholder="Type a location" name="where"
                               value={props.searchLocation} onChange={props.onChange}/>
                </Paper>
            </Grid>
        </Grid>
        <br/>
        ...
        <br/>
        <Button variant="contained" color="primary" className={classes.button} startIcon={<SearchIcon/>}
                aria-label="search" type="submit" onClick={props.onSearch}>
            Search
        </Button>
        <br/>
    </div>);
